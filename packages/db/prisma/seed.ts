...
const MENU_ITEMS: Record<string, Array<{
  ...
  starters: [
    { name: 'Paneer Tikka', description: 'Cottage cheese cubes marinated in spices and grilled to perfection', imageUrl: 'https://images.unsplash.com/photo-1567188040759-fb8a883dc6d8?w=600', price: 299, preparationTime: 15, isVegetarian: true, isGlutenFree: true, customizations: [{ name: 'Portion', type: CustomizationType.SIZE, isRequired: true, minSelections: 1, maxSelections: 1, options: [{ name: 'Regular (4 pcs)', priceModifier: 0, isDefault: true }, { name: 'Large (8 pcs)', priceModifier: 150 }] }, { name: 'Spice Level', type: CustomizationType.ADDON, isRequired: false, minSelections: 0, maxSelections: 1, options: [{ name: 'Mild', priceModifier: 0 }, { name: 'Medium', priceModifier: 0 }, { name: 'Hot', priceModifier: 0 }] }] },
    { name: 'Mushroom Chilli', description: 'Button mushrooms in spicy Indo-Chinese sauce', imageUrl: 'https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=600', price: 279, preparationTime: 12, isVegetarian: true, isVegan: true, customizations: [{ name: 'Portion', type: CustomizationType.SIZE, isRequired: true, minSelections: 1, maxSelections: 1, options: [{ name: 'Regular', priceModifier: 0, isDefault: true }, { name: 'Large', priceModifier: 100 }] }, { name: 'Spice Level', type: CustomizationType.ADDON, isRequired: false, minSelections: 0, maxSelections: 1, options: [{ name: 'Mild', priceModifier: 0 }, { name: 'Medium', priceModifier: 0 }, { name: 'Hot', priceModifier: 0 }] }] },
    { name: 'Chilli Paneer Dry', description: 'Paneer cubes in spicy chilli sauce', imageUrl: 'https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=600', price: 289, preparationTime: 12, isVegetarian: true, isGlutenFree: true, customizations: [{ name: 'Portion', type: CustomizationType.SIZE, isRequired: true, minSelections: 1, maxSelections: 1, options: [{ name: 'Regular (6 pcs)', priceModifier: 0, isDefault: true }, { name: 'Large (12 pcs)', priceModifier: 140 }] }, { name: 'Spice Level', type: CustomizationType.ADDON, isRequired: false, minSelections: 0, maxSelections: 1, options: [{ name: 'Mild', priceModifier: 0 }, { name: 'Medium', priceModifier: 0 }, { name: 'Hot', priceModifier: 0 }] }] },
